<script type="text/javascript">
  ...
  function submitData() {
                ...
                var b ="Nuova richiesta di contatto: <br> Nome: " + name + "<br> Email:" + email;
                if(message!=""){
                  b += "<br> Messaggio:" + message;
                }
                if(phone!=""){
                  b += "<br> Numero di telefono:" + phone;
                }
                var json = { body: b};
                $.ajax({
                    type: "POST",
                    url: "https://2oc8ao6xtc.execute-api.eu-west-1.amazonaws.com/veronicamail",
                ...
                alert("Grazie dell\'interesse, ti risponderò appena possibile!");
            }
</script>
<script async>
  setTimeout(function () {
